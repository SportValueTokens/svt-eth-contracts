...
*/
contract SportTradeCoin is ERC20 {
  ...
  string public constant name = "Sport Trade Coin";

  uint256 public constant decimals = 18;

  uint256 public constant TOTAL_SUPPLY = 100 * (10 ** 6) * 10 ** decimals; // 100 millions
  ...
  */
  function SportTradeCoin() public {
    owner = msg.sender;
