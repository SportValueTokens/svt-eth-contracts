...
const StableCoinToSVCExchange = artifacts.require('exchage/StableCoinToSVCExchange.sol')
...
module.exports = async function (deployer, network, accounts) {
  ...
  if (network === 'development' && process.env.NODE_ENV !== 'test') {
    ...
    await deployer.deploy(StableCoinToSVCExchange, SportValueCoin.address, MintableToken.address, 'TSD')
    console.log('StableCoinToSVCExchange deployed at: ', StableCoinToSVCExchange.address)
